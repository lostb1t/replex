...
run:
	REPLEX_AUTO_SELECT_VERSION=0 REPLEX_FORCE_MAXIMUM_QUALITY=1 REPLEX_CACHE_ROWS=0 REPLEX_HERO_ROWS="movies.recent,movie.recentlyadded" REPLEX_PORT=80 REPLEX_INCLUDE_WATCHED=1 REPLEX_REDIRECT_STREAMS=0 REPLEX_DISABLE_RELATED=0 REPLEX_DISABLE_LEAF_COUNT=0 REPLEX_DISABLE_USER_STATE=1 REPLEX_ENABLE_CONSOLE=0 REPLEX_CACHE_TTL=100 REPLEX_HOST=https://46-4-30-217.01b0839de64b49138531cab1bf32f7c2.plex.direct:42405 RUST_LOG="info,replex=debug" cargo watch -x run
