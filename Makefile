...
# run:
# 	REPLEX_CACHE_TTL=0 REPLEX_HOST=http://46.4.30.217:42405 REPLEX_NEWRELIC_API_KEY="eu01xx2d3c6a5e537373a8f8b52003b3FFFFNRAL" RUST_LOG="info,replex=info" cargo watch -x run
