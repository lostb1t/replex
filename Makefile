...
docker-build:
	docker build -t ghcr.io/sarendsen/replex:test . -f docker/Dockerfile.github
...
run:
	REPLEX_ENABLE_CONSOLE=0 REPLEX_CACHE_TTL=0 REPLEX_HOST=https://46-4-30-217.01b0839de64b49138531cab1bf32f7c2.plex.direct:42405 RUST_LOG="info,replex=debug" cargo watch -x run
