...
There is no real reason to ise the stabdalone version. And i advice against using the standalone versio tho, as there is no harm or real overhead in using the main and is already configured properly. 
