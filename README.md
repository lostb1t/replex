...
- when include_watched is false a mximum item limit per library is opposed of 250 items. So if you have a mixed row of 2 librsries the max results of that row will be 500 items.