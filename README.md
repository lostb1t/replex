...
I advice against using the standalone versio tho, as there is no harm or real overhead in using the main and its correctly set for you as paths in the future caan change. 
